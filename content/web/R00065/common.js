...
const logoEvents = [{
    ...
    month: 2,
    date: [11, 15],
    logos: ["rose", "love", "nolove", "love2", "kiss"]
}, {
    month: 9,
    date: 17,
...
function AddCap(e) {
    $("#" + e).html('<div class="g-recaptcha" data-sitekey="6LfdEVMeAAAAAMeaJ63Cc5_37LTVWTHDGAUbzK-0" data-size="compact"></div>\n  <script type="text/javascript" src="https://www.google.com/recaptcha/api.js"><\/script>')
}
