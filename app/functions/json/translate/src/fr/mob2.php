...
$array = [
     ...
     ''.XAT_NAME.'user' => 'Utilisateur '.XAT_NAME.' ?',
     ...
     'addfav' => 'Pour ajouter des groupes favoris, cliquez sur l’étoile grise à côté des groupes '.XAT_NAME.'',
     ...
     'getpower' => 'Obtenez-le',
     'confirm' => 'Confirmez votre achat dans le magasin '.XAT_NAME.'',
     'need'.XAT_NAME.'id' => 'Il vous faut un ID '.XAT_NAME.' pour utiliser '.XAT_NAME.'. Connectez-vous ou inscrivez-vous.',
