...
class GroupOptionEdit {
	public function index() {
		if (\Server::isRealUser() == false) {
			return http_response_code(403);
		}
		$getId   = (int) \Server::get('id');
		$gp      = [74,80,90,92,96,98,100,102,106,108,112,114,130,148,150,156,180,188,192,194,200,206,220,224,238,246,252,256,278,296,300];
		$js      = [];
		$html    = [];
		$gethtml = '';
		$getjs   = '';
		...
		$getPage = View::get('web_gear/GroupOptionEdit', ['title' => XAT_NAME.' group option edit', 'html' => $gethtml, 'js' => $getjs]);
