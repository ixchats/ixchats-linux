var Defaults = {'rnk':'3','dt':'300','lv':'1','rt':'10','lm':'0'};
var Min = {'dt':'10','lv':'1','rt':'10','lm':'Array', 0:0};
var Max = {'dt':'900','lv':'99','rt':'600', 0:0};
  
 function changeParent(){
	 //var Txt = opener.document.getElementById('gi_200'); 
	 //Txt.value = v;
	 var o, i, j, idc=0, b=0;
	 for (o in Defaults)
	 {
